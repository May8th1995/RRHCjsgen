...
{
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_2, //ABILITY Weak Armor
...
static const struct BattleTowerSpread sExpertBossBattle_RocketHideout_Giovanni1[] =
{
	...
	},
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_1, //ABILITY Earth Eater
		.item = ITEM_SITRUS_BERRY, 
		.moves =
		{
			MOVE_HEAVYSLAM,
...
//perma rain
{
	...
	{
		.species = SPECIES_PALAFIN_HERO, //pretransformed
		.nature = NATURE_JOLLY,
		.level = 68,
		.hpIv = 31,
		.atkIv = 31,
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_HIDDEN, //ABILITY Mold Breaker KEKW
		.item = ITEM_MYSTIC_WATER,
		.moves =
		{
			MOVE_JETPUNCH,
...
//perma electric terrain, perma magnet rise
{
	...
	},
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_1, //ABILITY Hadron Engine
		.item = ITEM_LEFTOVERS, 
		.moves =
		{
			MOVE_CALMMIND,
...
//harsh sunlight (water moves do no damage)
{
	...
	},
	{
		...
		.moves =
		{
			...
			MOVE_HYDROSTEAM, 
			MOVE_FLAMETHROWER, 
			MOVE_SLEEPTALK, //doesnt really need a 4th slot lol 
		},
		.ball = BALL_TYPE_MASTER_BALL,
	},
	{
...
static const struct BattleTowerSpread sExpertBossBattle_CeruleanCave_Grunt1[] =
{
	...
	},
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_2, //ABILITY Speed Boost
		.item = ITEM_FOCUS_SASH, 
		.moves =
		{
			MOVE_PROTECT,
...
static const struct BattleTowerSpread sHardcoreBossBattle_CapeBrink_DHBattle[] =
{
	...
	},
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_2, //ABILITY Super Luck, Sharpness Mega
		.item = ITEM_ABSOLITE, 
		.moves =
		{
			MOVE_NIGHTSLASH,
...
{
	{
		...
		.spDefIv = 31,
		.spdIv = 31,
		.ability = FRONTIER_ABILITY_1, //ABILITY Frisk
		.item = ITEM_PIDGEOTITE,
		.moves =
		{
			MOVE_HURRICANE,
